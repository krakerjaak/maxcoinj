...
public class Block extends Message {
    ...
    Block(NetworkParameters params) {
        ...
        version = params.getGenesisBlockVersion();
        difficultyTarget = params.getGenesisBlockDiffTarget();
    ...
    private void parseHeader() throws ProtocolException {
        ...
        hash = new Sha256Hash(CoinDefinition.get().blockHash(payload, offset, cursor));
    ...
    private Sha256Hash calculateHash() {
        try {
            ...
            writeHeader(bos);
            return new Sha256Hash(CoinDefinition.get().blockHash(bos.toByteArray()));
        } catch (IOException e) {
